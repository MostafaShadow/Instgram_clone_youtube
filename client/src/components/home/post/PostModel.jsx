            ...
            <Box sx={{ margin: "10px 10px" }}>
              <form style={{ padding: "10px 20px" }} onSubmit={handleAddPost}>
                ...
                <Stack>
                  <Button
                    variant="contained"
                    sx={{ padding: "8px", fontWeight: "600", fontSize: "17px" }}
                    disabled={isClickSave || (!post && true)}
                    type="submit"
                  >
                ...
                <Stack sx={{ margin: "0 10px", position: "relative" }}>
                  ...
                  >
                    <IconButton size="large" onClick={handleShowEmoji}>
                      <EmojiEmotionsOutlinedIcon style={{ fontSize: "35px" }} />
                    </IconButton>
                  </Tooltip>
                  {showEmoji && (
                    <Box
                  ...
                  <Tooltip title="Gallery" arrow>
                    <IconButton size="large" onClick={handelOpenInputFile}>
                      <input
                        ...
                        style={{ display: "none" }}
                      />
                      <InsertPhotoOutlinedIcon style={{ fontSize: "35px" }} />
                    </IconButton>
                  </Tooltip>
                </Stack>
              </Box>
